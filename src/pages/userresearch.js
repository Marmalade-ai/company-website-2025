    ...
    <Layout>
      ...
      <main>
        ...
        <div className="grid sm:grid-cols-2 gap-4 p-4">
          ...
          <div>
            <p className="largeText"><b>Please click to schedule!</b><br/>
            if &quot;no,&quot; please forward to specialists you know.</p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <p className="py-4"><b>What geographical scope?</b> Should your scope be a city, a metro area, a state, a region, like &quot;Upper Midwest&quot; or &quot;West Coast&quot;? What is a geography UI?</p>
        </div>
