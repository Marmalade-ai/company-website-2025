...
const NewAboutPage = () => {
  return (
    <Layout>
      <main><h1>New About Marmalade AI, Inc.</h1>
        ...
        <div class="black-border">
          ...
          <div>
            ...
            career stages and professions encounter in networking:</p><br/>
            ...
            <br/>
            <p>We found each other through user research into networking, then connected remotely, and developed a prototype in Figma.
